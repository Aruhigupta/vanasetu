...
from app_backend.models.models import HerbCollection, QRHistory, BlockchainTransaction, User, Farmer, LabReport, TransportLog
from app_backend.services.qr_service import QRService
...
def generate_qr(batch_id: str):
    verification_url = f"https://frontend-seven-teal-61.vercel.app/verify/{batch_id}"
