...
from app.models.models import User, Farmer, Collector, Herb, HerbCollection, LabReport, TransportLog, Manufacturer, BlockchainTransaction, QRHistory
import datetime
...
def seed_db():
    ...
    print("Seeding HerbChain AI Database with AYUSH herbs, users, collections, and blockchain records...")
    ...
    # 3. Create Sample Batch HCB-2025-ASH01
